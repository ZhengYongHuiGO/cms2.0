            ...
            <div class="box span12">
                ...
                <div class="box-content">
                    <table class="table table-bordered table-striped table-condensed">
                        ...
                        <tbody>
                        <c:forEach items="${filmBanners}" var="me" varStatus="vs">
                            <tr>
                                <td class="center">${vs.count}</td>
                                <td class="center">
                                    <fmt:formatDate value="${me.publishDate}" pattern="yyyy-MM-dd HH:mm:ss"/>
                                </td>
                                <td class="center">
                                    <c:if test="${me.film==null}">暂无</c:if>
                                    <c:if test="${me.film!=null}">${me.film.filmname}</c:if>
                                </td>
                                <td class="center">
